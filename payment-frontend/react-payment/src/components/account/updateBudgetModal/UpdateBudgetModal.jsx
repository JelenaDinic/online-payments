...
const UpdateBudgetModal = ({setDisplayModal}) => {
    ...
    const send = async (e, elements, stripe) => {
        ...
        if (error) {
            ...
            backend.post("/Transaction/", { userId: id, recipientEmail: "own", amount: amount })
                .then((response) => {
                    alert("Money is successfully added!")
    ...
    return (
        <div className="update-budget-modal">
            <span onClick={(e) => {
                e.preventDefault();
                setDisplayModal(false);
            }}>X</span>
            <div className="card mb-4 mt-4">
                <div className="card-header">Update your budget</div>
